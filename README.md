...
Cookie Cats A/B testing dataset (90,189 users). A real experiment from a mobile game testing whether changing when users hit a progression gate affects Day 1 and Day 7 retention. Source: [Cookie Cats A/B Testing Dataset](https://www.kaggle.com/datasets/yufengsui/mobile-games-ab-testing) (public domain, via Kaggle).
